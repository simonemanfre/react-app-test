        ...
        <footer className="c-card__footer">
          <section className="c-card__text">
            <p>
              ...
              amet quod magnam consequatur rerum sunt rem fuga nobis, corporis
              dicta reiciendis vel qui impedit repellendus! Assumenda quod qui
              sint hic suscipit aperiam eos, totam corrupti rem expedita iste
              delectus laborum?
            </p>
          </section>
